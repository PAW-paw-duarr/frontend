...
export function EditUserSidebar({ isOpen, onClose, user, teams, onSave }: EditUserSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed right-0 top-0 h-screen w-96 bg-white shadow-xl z-50 transform transition-transform duration-300 overflow-y-auto ${
      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
          ...
          {/* Button */}
          <div className="sticky bottom-0 pt-6 pb-4 border-t border-gray-200 bg-white">
            <Button
              type="submit"
