    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'right' &&
            'data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right lg:e-[45vw] inset-y-0 right-0 h-full w-full border-l lg:w-1/2 xl:w-[45vw]',
          side === 'left' &&
            'data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left inset-y-0 left-0 h-full w-full border-r sm:w-1/2 lg:w-[45vw]',
          side === 'top' &&
...
function SheetHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="sheet-header" className={cn('flex items-center gap-1.5 py-4', className)} {...props} />;
}
